...
def create_train_data_loader_for_image_pairs(batch_size: int, num_workers: int):
    ...
    dataset_weights_mapping_train: dict[torch.utils.data.Dataset, float] = {Hi_UCD_dataset_train: 1.0}
...
def create_val_data_loader_for_image_pairs(batch_size: int, num_workers: int):
    ...
    dataset_weights_mapping_val: dict[torch.utils.data.Dataset, float] = {Hi_UCD_dataset_train: 0.25}
